<template>
    ...
    >
      <div v-if="image" class="rounded-t-lg overflow-hidden">
        <a :href="url">
          <img
            class="rounded-t-lg transform hover:scale-110 duration-300 w-full h-96"
            :src="image"
            :alt="name"
          />
        </a>
      ...
      <div class="mt-5 px-5">
        <a :href="url">
          <h5
            class="mb-2 sm:mb-4 text-lg sm:text-xl font-semibold tracking-tight text-gray-300"
          >
            {{ name }}
          </h5>
        </a>
